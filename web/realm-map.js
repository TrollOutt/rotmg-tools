...
var RealmMap = (function () {
   ...
   */
  const TIERS = [
    { key: 'encounters', from: 0.5, world: 15, cap: 3 },
    { key: 'heroes', from: 1.7, world: 11, cap: 3 },
    { key: 'regular', from: 3.4, world: 8, cap: 6 }
  ];
  ...
  function drawLife(time, scale) {
    for (const region of regions) {
      ...
      for (const being of region.life) {
        ...
        const drawn = Math.max(13, Math.min(46, being.tier.world * scale));
