...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        resultsWidget->setGeometry(QRect(630, 10, 691, 791));
        resultsWidget->setFont(font1);
        resultsWidget->setStyleSheet(QString::fromUtf8("QTableWidget\n"
"{\n"
...
"}"));
        ...
        resultsWidget->setFrameShadow(QFrame::Shadow::Plain);
        resultsWidget->setLineWidth(0);
        resultsWidget->setHorizontalScrollBarPolicy(Qt::ScrollBarPolicy::ScrollBarAlwaysOff);
        ...
        CalculateButton->setGeometry(QRect(490, 290, 131, 181));
        QFont font2;
        font2.setPointSize(24);
        CalculateButton->setFont(font2);
        CalculateButton->setAutoFillBackground(false);
        CalculateButton->setStyleSheet(QString::fromUtf8("QPushButton::Disabled\n"
"{\n"
"	background-color: rgba(169,250,124,80);\n"
"}\n"
"\n"
"QPushButton::Enabled\n"
"{\n"
"	background-color: rgba(169,250,124,180);\n"
"}\n"
"\n"
"QPushButton::hover\n"
"{\n"
"	background-color: rgba(169,250,124,220);\n"
"}"));
        QIcon icon(QIcon::fromTheme(QIcon::ThemeIcon::MediaPlaybackStart));
        CalculateButton->setIcon(icon);
        CalculateButton->setIconSize(QSize(80, 80));
        rarityWidget = new QComboBox(centralwidget);
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/Item Rarities/GUI Files/Item Rarities/uncommon_scaled_8x.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        rarityWidget->addItem(icon1, QString());
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/Item Rarities/GUI Files/Item Rarities/rare_scaled_8x.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        rarityWidget->addItem(icon2, QString());
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/Item Rarities/GUI Files/Item Rarities/legendary_scaled_8x.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        rarityWidget->addItem(icon3, QString());
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/Item Rarities/GUI Files/Item Rarities/divine_scaled_8x.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        rarityWidget->addItem(icon4, QString());
        rarityWidget->setObjectName("rarityWidget");
        rarityWidget->setGeometry(QRect(10, 10, 211, 71));
        QFont font3;
        ...
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/Dust Types/GUI Files/Dust Types/Green.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        dustTypeWidget->addItem(icon5, QString());
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/Dust Types/GUI Files/Dust Types/Red.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        dustTypeWidget->addItem(icon6, QString());
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/Dust Types/GUI Files/Dust Types/Purple.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        dustTypeWidget->addItem(icon7, QString());
        dustTypeWidget->setObjectName("dustTypeWidget");
        dustTypeWidget->setGeometry(QRect(430, 10, 191, 71));
        dustTypeWidget->setFont(font3);
        dustTypeWidget->setIconSize(QSize(40, 40));
        itemTypeWidget = new QComboBox(centralwidget);
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/Item Types/GUI Files/Item Types/weapon.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        itemTypeWidget->addItem(icon8, QString());
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/Item Types/GUI Files/Item Types/ability.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        itemTypeWidget->addItem(icon9, QString());
        QIcon icon10;
        icon10.addFile(QString::fromUtf8(":/Item Types/GUI Files/Item Types/armor.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        itemTypeWidget->addItem(icon10, QString());
        QIcon icon11;
        icon11.addFile(QString::fromUtf8(":/Item Types/GUI Files/Item Types/ring.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        itemTypeWidget->addItem(icon11, QString());
        itemTypeWidget->setObjectName("itemTypeWidget");
        itemTypeWidget->setGeometry(QRect(230, 10, 191, 71));
        ...
        awakenedItemWidget->setGeometry(QRect(10, 90, 331, 71));
        QFont font4;
        font4.setPointSize(16);
        awakenedItemWidget->setFont(font4);
        awakenedItemWidget->setStyleSheet(QString::fromUtf8("QComboBox QAbstractItemView::item \n"
"{ max-height: 44px; }"));
...
"{\n"
"background-color: rgba(130, 20, 20,110);\n"
"color: white;\n"
"border-style: outset;\n"
"border-width: 1px;\n"
"border-color: rgba(80,0,0,90);\n"
"padding: 0px;\n"
"border-radius: 4px;\n"
"}\n"
"QPushButton:pressed\n"
...
"QPushButton:Hover\n"
"{\n"
"background-color: rgba(200,30,30,180);\n"
"}\n"
""));
...
"color: rgb(149, 149, 149)"));
        ...
        QIcon icon12;
        icon12.addFile(QString::fromUtf8(":/Item Types/GUI Files/Item Types/SUMMONPOWERED.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon13;
        icon13.addFile(QString::fromUtf8(":/Item Types/GUI Files/Item Types/ALIEN.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon14;
        icon14.addFile(QString::fromUtf8(":/Item Types/GUI Files/Item Types/NEO_ALIEN.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
...
""));
        ...
        clearAwakenWidget = new QPushButton(centralwidget);
        clearAwakenWidget->setObjectName("clearAwakenWidget");
        clearAwakenWidget->setEnabled(true);
        clearAwakenWidget->setGeometry(QRect(320, 90, 20, 20));
        clearAwakenWidget->setFont(font7);
        clearAwakenWidget->setStyleSheet(QString::fromUtf8("QPushButton\n"
"{\n"
"background-color: rgba(130, 20, 20,110);\n"
"color: white;\n"
"border-style: outset;\n"
...
""));
        ...
        cacheButton->setGeometry(QRect(120, 680, 151, 71));
        progressBar = new QProgressBar(centralwidget);
        progressBar->setObjectName("progressBar");
        progressBar->setGeometry(QRect(500, 470, 121, 31));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        CalculateButton->setText(QString());
        ...
        clearAwakenWidget->setText(QCoreApplication::translate("MainWindow", "X", nullptr));
        cacheButton->setText(QCoreApplication::translate("MainWindow", "Build Cache", nullptr));
    } // retranslateUi
